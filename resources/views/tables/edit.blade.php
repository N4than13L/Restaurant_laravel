        ...
        <div class="row justify-content-center">
            <div class="col-md-8 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('table.update', ['id' => $table->id]) }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        ...
                                        value="{{ $table->name }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select name="menu_id" class="form-select" aria-label="Default select example">
                                        <option>Selecciona el menu</option>
                                        @foreach ($menu as $menus)
                                            <option selected value="{{ $menus->id }}">
                                                <p>{{ $menus->name }}</p>
                                            </option>
                                        @endforeach
