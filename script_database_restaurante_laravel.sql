...
DROP FOREIGN KEY `fk_tables_menus1`;
...
DROP INDEX `fk_tables_menus1_idx` ;
;
...
ALTER TABLE `restaurante_laravel`.`tables` ADD CONSTRAINT `fk_tables_clients1`
